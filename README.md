...
Stage 19.1:
- cosmetic hats/helmets/etc. and hair styles now work together better so covered hair stays under the hat/helmet while uncovered hair remains visible naturally
- no hair clipping above hats/helmets/etc.
- added a hide hat/helmet/etc. option so players can wear a cosmetic skin without affecting their hair
